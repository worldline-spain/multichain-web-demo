...
<?php
		...
		if (isset($_GET['key'])) { // List of publications by an specific key
		...
		} elseif (isset($_GET['publisher'])) { // List of publications by an specific publisher address
		...
		} else if (isset($viewstream)) { // Stream items when stream is selected
